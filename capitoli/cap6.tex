\chapter{Conclusioni e sviluppi futuri}
	...
	inoltre si presta bene solo per la scrittura di script o piccole applicazioni, altri linguaggi offrono un supporto molto maggiore alla programmazione in grande (C++, Java, Rust, etc).
